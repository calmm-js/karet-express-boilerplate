...
export const xhrJSON = /*#__PURE__*/ onClient(({method, url, body}) =>
...
export const putJSON = /*#__PURE__*/ onClient(
  R.curry((url, body) => xhrJSON({method: 'PUT', url, body}))
)
export const postJSON = /*#__PURE__*/ onClient(
  R.curry((url, body) => xhrJSON({method: 'POST', url, body}))
)
